import os
from utilities import passwordgen, hash_text, unitconv
...
while True:
    ...
    if opcao == "1":
        ...
        print("cleaning complete you can now go back to the menu")
    elif opcao == "2":
        print("Current clipboard history")
        print("-------------------------")
        print("(if there is nothing in here you might have disabled it)")
        ...
        if not os.path.isfile(img_orig):
            ...
            try:
                with Image.open(img_orig) as img:
                    ...
                    img.save(out_name)
                print("Conversion complete! Saved as " + out_name)
